...
/**
 * This class is the temporary hero that is assigned to the main hero for loading data into
 * it is mainly used to instantiate a hero so that it isnt null so data can be saved into it
 * @author Lukey
 */
public class TempHero extends Hero {
    ...
    private static int[] weaponDamageList = { 10, 20, 30, 40 };
    ...
    /**
    * Constructor: initializes a temporary hero and sets up with the parameters given
    * @param name
    * @param type
    * @param health
    * @param level
    * @param damage 
    */
    public TempHero(String name, String type, int health, int level, int damage) {
