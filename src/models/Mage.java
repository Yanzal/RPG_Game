...
/**
 * This class represents a character that is based as an Mage
 * A Mage has different stats compared to other characters
 * @author Lukey
 */
public class Mage extends Hero {
    ...
    */
    ...
    public Mage(String name, String type, int health, int level, int damage) {
