...
/**
 * This class represents a character that is based as an Archer
 * An Archer has different stats compared to other characters
 * @author Lukey
 */
public class Archer extends Hero {
    ...
    private static int[] weaponDamageList = { 7, 12, 17, 22 };
    private static String weapon = "Bow";
    private static String[] weapons = { "Stick", "Plastic", "Wood", "Metal" };
    private static ArrayList<String> inventory;
    private static int arrayIndex = 0;
    
    /**
     * Constructor: initializes an archer and sets up with the parameters given
     * @param name
     * @param type
     * @param health
     * @param level
     * @param damage 
     */
    public Archer(String name, String type, int health, int level, int damage) {
